...
func handlerPost(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		...
		// if update gcs success, update elasticsearch success, do we need to remove it from gcs
		// no, it is not user active. Can use a GC to remove it when not busy
		// sacrifice space to get user satisfaction
		return
	}
	// Return success
